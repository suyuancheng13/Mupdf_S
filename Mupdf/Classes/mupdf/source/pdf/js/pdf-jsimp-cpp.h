...
//new a array object
const char *pdf_jsimp_new_array_obj_cpp(pdf_jsimp *imp, pdf_jsimp_type *type, pdf_jsimp_obj *natobj[2], pdf_jsimp_obj **obj);
...
//add the to boolean 
const char *pdf_jsimp_to_boolean_cpp(pdf_jsimp *imp, pdf_jsimp_obj *obj,   int *boo);
